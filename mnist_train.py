...
import config
from models import MNISTDisCov, nnPUloss
import pixelcnn
...
class Trainer(object):
    ...
    def __init__(self, config, args):
        ...
        self.dis = MNISTDisCov(noise_size=config.noise_size, num_label=config.num_label).cuda()
    ...
    def train(self):
        ...
        print
        config.train_batch_size % len(self.unlabeled_loader)
        self.param_init()
